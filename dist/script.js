...
/* harmony import */ var _modules_customizator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/customizator */ "./src/js/modules/customizator.js");
/* harmony import */ var _modules_parcer__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/parcer */ "./src/js/modules/parcer.js");


window.addEventListener('DOMContentLoaded', function () {
  var panel = new _modules_customizator__WEBPACK_IMPORTED_MODULE_0__["default"]();
  panel.render();
  Object(_modules_parcer__WEBPACK_IMPORTED_MODULE_1__["default"])();
});
...
function () {
  ...
  _createClass(Customizator, [{
    key: "setScale",
    value: function setScale(element) {
      var _this = this;

      element.childNodes.forEach(function (node) {
        if (node.nodeName === '#text' && node.length > 13) {
          var fontSize = window.getComputedStyle(node.parentNode, null).fontSize;

          if (_this.scale === 1.5 && !node.parentNode.style.fontSize) {
            node.parentNode.style.fontSize = parseInt(fontSize) * _this.scale + 'px';
    ...
    key: "scaleChange",
    value: function scaleChange(event) {
    ...
    key: "clear\u0421ustomization",
    value: function clearUstomization() {
      this.scale = 1;
      this.setScale(document.body);
      this.color = '#ffffff';
      this.setColor();
    ...
    value: function render() {
      ...
      this.btnBlock.addEventListener('click', function (event) {
        return _this2.scaleChange(event);
      });
      this.colorPicker.addEventListener('input', function (event) {
        return _this2.colorChange(event);
      });
      this.clear.addEventListener('click', function () {
        return _this2.clearСustomization();
      });
    }
  }]);
...
var parcer = function parcer() {
  var getH1Content = function getH1Content(element) {
    if (element.nodeName === "H1") {
      var contentH1 = element.textContent;
      var objH1 = {
        h1: contentH1
      };
...
/* harmony default export */ __webpack_exports__["default"] = (parcer);
